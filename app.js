...
document.getElementById("assignment-text").innerText = "View Assignment";
...
function viewProfile() {
    document.getElementById("user-data-username").innerText = window.localStorage.getItem("user-userName");
    document.getElementById("user-data-email").innerText = window.localStorage.getItem("user-email");
    document.getElementById("user-data-gender").innerText = window.localStorage.getItem("user-gender");
    document.getElementById("user-data-dob").innerText = window.localStorage.getItem("user-dob");
    document.getElementById("user-data-number").innerText = window.localStorage.getItem("user-Number");
    document.getElementById("user-data-postal").innerText = window.localStorage.getItem("user-postal");
    document.getElementById("container").style.display = "none";
    document.getElementById("container2").style.display = "none";
...
function viewAssignment(){
    if(document.querySelector(".assignments").style.display === "flex"){
        document.getElementById("container").style.display = "none";
        document.getElementById("container2").style.display = "none";
        document.getElementById("container3").style.display = "block";
        document.querySelector(".user-data").style.display = "none";
        ...
        document.getElementById("assignment-text").innerText = "Hide Assignment";
